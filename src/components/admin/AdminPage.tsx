    ...
    return ( 
        <>
            ...
            <Flex align='center' justify='center' mt={5} fontWeight={600}>  
                ...
                { showList ?
                  <Button m ={2} p={5} cursor='pointer' isLoading={loading} onClick={fetchLectureData} >
                  ...
                  <Box  m ={2} p={5} boxShadow='1px 1px 3px 2px rgba(97, 143, 217, .25)'>
                    <Flex align='center' justify='center' flexDirection='column' mt='20px'>
                      <Text fontWeight={600} fontSize={20}>Previously Made Quizes</Text>
                                    ...
                                    <ListItem key={index}> 
                                        ...
                                        >
                                          <Flex direction='column'>
                                            ...
                                            <Text >Number of learning oblectives: {prevID.numberOfLearningObjectives}</Text>
                                            <Text >Created at: {new Date(prevID.createdAt.seconds * 1000).toLocaleDateString()}</Text>
                                          </Flex> 
                                        </Button>
